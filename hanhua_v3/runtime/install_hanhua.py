# -*- coding: utf-8 -*-
"""
DBO Zero 漢化補丁構建／安裝模組。

從本機遊戲原始資源產出大陸簡中與台灣繁中「複製式」補丁。
不修改遊戲程式、DLL、反作弊或 pack 本體結構以外的系統檔。

台灣用字修正表見同目錄 taiwan_fixups.py（唯一來源）。
"""
...
from .taiwan_fixups import TAIWAN_SIMPLIFY_FIXUPS
...
# Taiwan preference pairs: single source in taiwan_fixups.py
# (imported above as TAIWAN_SIMPLIFY_FIXUPS)
