#!/usr/bin/env python3
"""Fix Item Ascend UI, rarity wording (稀少度), Materials/Success Rate/Zeni, CC status labels."""
...
BY_ID = {
    ...
    "DST_ITEMGRADETRANSFER_RANK_ERR": "道具稀少度必須相同。",
    "GAME_ITEM_ASCEND_NO_CONFIG": "該裝備無法進階（未找到配方）。",
    "GAME_ITEM_ASCEND_MAX_RANK": "該裝備已達最高稀少度。",
    "GAME_ITEM_ASCEND_INVALID_ITEM": "該裝備目前無法進階。",
}
